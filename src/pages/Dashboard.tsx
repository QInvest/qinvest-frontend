      ...
      <div className="flex">
        ...
        <aside className="w-64 bg-white border-r border-border h-[calc(100vh-4rem)] sticky top-16 hidden lg:block">
          <nav className="p-4 space-y-2">
            <Link to="/dashboard" className="flex items-center space-x-3 px-3 py-2 bg-primary/10 text-primary rounded-lg font-medium">
              <TrendingUp className="h-5 w-5" />
              <span>Dashboard</span>
            </Link>
            <Link to="/opportunities" className="flex items-center space-x-3 px-3 py-2 text-muted-foreground hover:bg-muted/50 hover:text-foreground rounded-lg transition-colors">
              <Target className="h-5 w-5" />
              <span>Oportunidades</span>
            </Link>
            <Link to="/meus-investimentos" className="flex items-center space-x-3 px-3 py-2 text-muted-foreground hover:bg-muted/50 hover:text-foreground rounded-lg transition-colors">
              <Eye className="h-5 w-5" />
              <span>Meus Investimentos</span>
            </Link>
            <Link to="/wallet" className="flex items-center space-x-3 px-3 py-2 text-muted-foreground hover:bg-muted/50 hover:text-foreground rounded-lg transition-colors">
              <CreditCard className="h-5 w-5" />
              <span>Carteira Virtual</span>
            </Link>
            <Link to="/credit-request" className="flex items-center space-x-3 px-3 py-2 text-muted-foreground hover:bg-muted/50 hover:text-foreground rounded-lg transition-colors">
